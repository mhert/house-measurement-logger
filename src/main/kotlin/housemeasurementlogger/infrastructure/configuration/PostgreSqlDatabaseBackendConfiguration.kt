...
class PostgreSqlDatabaseBackendConfiguration {
    @Bean
    fun measurementRepositoryDataSource(
    ...
    @Bean
    fun measurementRepository(dataSource: PGDataSource): MeasurementRepository {
